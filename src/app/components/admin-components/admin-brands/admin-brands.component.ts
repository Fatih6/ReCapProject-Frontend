...
import { BrandAddComponent } from '../../add-components/brand-add/brand-add.component';
import { BrandUpdateComponent } from '../../update-components/brand-update/brand-update.component';
...
export class AdminBrandsComponent implements OnInit {
  ...
  delete(brand:Brand) {
    this.confirmationService.confirm({
        message:  brand.brandName + ' adlı markayı silmek istediğinize emin misiniz?',
        accept: () => {
